describe "Rahani.Views.Payments.Form", ->
  createView = (model = new Rahani.Models.Payment())->
    ...
    view = new Rahani.Views.Payments.Form
      model: model
      categories: categories
    view

  it "should be defined", ->
    expect(Rahani.Views.Payments.Form).toBeDefined()

  it "should use the correct template", ->
    expect(Rahani.Views.Payments.Form).toUseTemplate('payments/form')
